...
export function HeroSection() {
  return (
    ...
    >
      ...
      />
      <div className="container-page py-14 sm:py-18 lg:py-22 xl:py-24">
        <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-12 xl:gap-16">
          <div className="flex max-w-2xl flex-col gap-6 lg:col-span-7 lg:max-w-none lg:gap-8">
            <span
          ...
          <div className="lg:col-span-5">
            <div className="relative">
              ...
              />
              <div className="relative overflow-hidden rounded-3xl bg-white shadow-elevated ring-1 ring-navy/10">
                <picture>
                  <source
